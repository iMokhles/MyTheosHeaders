...
@interface OBJCIPC_IMOKH_WAConnection : NSObject<NSStreamDelegate> {
...
- (void)sendMessage:(OBJCIPC_IMOKH_WAMessage *)message;
- (void)closeConnection;
- (void)setIncomingMessageHandler:(OBJCIPC_IMOKH_WAIncomingMessageHandler)handler forMessageName:(NSString *)messageName;
- (OBJCIPC_IMOKH_WAIncomingMessageHandler)incomingMessageHandlerForMessageName:(NSString *)messageName;
