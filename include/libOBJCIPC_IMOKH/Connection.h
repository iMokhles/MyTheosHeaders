...
@interface OBJCIPC_IMOKHConnection : NSObject<NSStreamDelegate> {
...
- (void)sendMessage:(OBJCIPC_IMOKHMessage *)message;
- (void)closeConnection;
- (void)setIncomingMessageHandler:(OBJCIPC_IMOKHIncomingMessageHandler)handler forMessageName:(NSString *)messageName;
- (OBJCIPC_IMOKHIncomingMessageHandler)incomingMessageHandlerForMessageName:(NSString *)messageName;
