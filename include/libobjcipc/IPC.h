...
@interface OBJCIPC_iMokh : NSObject {
...
// SpringBoard* -----> App
+ (BOOL)sendMessageToAppWithIdentifier:(NSString *)identifier messageName:(NSString *)messageName dictionary:(NSDictionary *)dictionary replyHandler:(OBJCIPC_iMokhReplyHandler)handler;

// App* -----> SpringBoard
+ (BOOL)sendMessageToSpringBoardWithMessageName:(NSString *)messageName dictionary:(NSDictionary *)dictionary replyHandler:(OBJCIPC_iMokhReplyHandler)handler;
...
// App -----> SpringBoard*
+ (void)registerIncomingMessageFromAppHandlerForMessageName:(NSString *)messageName handler:(OBJCIPC_iMokhIncomingMessageHandler)handler;
...
+ (void)registerIncomingMessageHandlerForAppWithIdentifier:(NSString *)identifier andMessageName:(NSString *)messageName handler:(OBJCIPC_iMokhIncomingMessageHandler)handler;
+ (void)unregisterIncomingMessageHandlerForAppWithIdentifier:(NSString *)identifier andMessageName:(NSString *)messageName;

// SpringBoard -----> App*
+ (void)registerIncomingMessageFromSpringBoardHandlerForMessageName:(NSString *)messageName handler:(OBJCIPC_iMokhIncomingMessageHandler)handler;
...
// manage connections
- (OBJCIPC_iMokhConnection *)activeConnectionWithAppWithIdentifier:(NSString *)identifier;
- (void)addPendingConnection:(OBJCIPC_iMokhConnection *)connection;
- (void)notifyConnectionBecomesActive:(OBJCIPC_iMokhConnection *)connection;
- (void)notifyConnectionIsClosed:(OBJCIPC_iMokhConnection *)connection;
- (void)removeConnection:(OBJCIPC_iMokhConnection *)connection;

// queue up the outgoing message
- (void)queueOutgoingMessage:(OBJCIPC_iMokhMessage *)message forAppWithIdentifier:(NSString *)identifier;
